...
\title*{Strategic Verification of Autonomous Systems}
...
\abstract{See \url{https://www.springer.com/gp/authors-editors/book-authors-editors/your-publication-journey/manuscript-preparation}}

\section{Section Heading}
\label{sec:1}
The problem with verification of autonomous systems/vehicles is the large state space and that no model is sufficient to provide complete confidence in the verification process... there will always be gaps in the coverage. 
\newline
\newline
Methods such as constrained randomisation are useful but may fail to find edge cases...Are random and edges cases sufficient...what criteria should we assess these systems against?
\newline
\newline
Should this be purely functional? Or should more weight be given to non-functional indicators such as transparency and predictability?
\newline
\newline
Using a methodology that drives towards specific assertions can provide a strategic means of test generation...
\newline
\newline
Split chapters:
\newline
\newline
1) Strategic Test Generation
- what methods can we use?\newline
- discuss how agent based test generation works\newline
- how to be strategic with agent actions\newline
- actions that are goal oriented\newline
- use RL to generate test agents in software\newline
- use of simulation...\newline
\newline
\newline
2) Assertions and Checking
- what are the sources?\newline
- use accidentology\newline
- the highway code/driving laws/regulations\newline
- non-functional criteria?\newline
- predictability/transparency/how do we expose these to the user to harness trustworthiness?\newline
